...
unsigned ntohl(unsigned arg)
{
	return ((arg >> 24) && 0xFF) | (((arg >> 16) && 0xFF) << 8) | (((arg >> 8) && 0xFF) << 16) | (((arg >> 0) && 0xFF) << 24);
}

unsigned htonl(unsigned arg)
{
	return ((arg >> 24) && 0xFF) | (((arg >> 16) && 0xFF) << 8) | (((arg >> 8) && 0xFF) << 16) | (((arg >> 0) && 0xFF) << 24);
}
...
#define _SC_PAGESIZE _SC_PAGE_SIZE
	...
	retval = ext2fs_get_device_size3(fd, blocksize, &max_size);
	if (retval) {
		com_err(program_name, retval, "%s",
